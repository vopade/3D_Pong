...
//----------------------------------------------------------------------------------------------------------------------#FUNCTIONS_PUBLIC
	...
	public void startNewGame()
	{
		...
		if (randomStart.x < 0) // Geschwindigkeit in x-Richtung erhöhen
		{
			randomStart.x -= 0.75f;
		}
		else
		...
		randomStart = generateBallDirection ();
		//randomStart = new Vector3(2f, 0f, 0f); // Nur zu Testzwecken, ist Startvektor
    ...
    {
        float newBallDirectionBoundary = 0.5f;
