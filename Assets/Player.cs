...
//----------------------------------------------------------------------------------------------------------------------#VARIABLES
	...
	private byte DEBOUNCE = 10;
	private byte timerLockKey;
	...
	private const float bounceDeviationFactor = 5f; //10f;
...
//----------------------------------------------------------------------------------------------------------------------#ONCOLLISIONENTER
	void OnCollisionEnter(Collision col) {
		...
		if (col.gameObject.name == "Ball") 
		{
			...
			/*
			if (!lockKeyPress) {
				giveBallnewAngleAfterCollisionWithPanel (col);
				lockKeyPress = true;
...
//----------------------------------------------------------------------------------------------------------------------#FIXEDUPDATE
    void FixedUpdate()
    {
        ...
        if (ItemHandler.eventFlags[(int)ItemHandler.Events.PanelShrinking])
        {
            ...
            if (timerPanelShrink <= 0.0f)
			{
				...
				foreach (GameObject ele in GameObject.FindGameObjectsWithTag ("Panel")) 
        ...
        if (gameObject.name == p1)
        {
            if (!Need.isSinglePlayer && !Need.ball_direction_x)
            {
	...
	private void handleIndication(Material color) {
		if (gameObject.name == p1) {
			//if (Need.ball_direction_x) {
				...
				if ((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z) {
					P1_5.GetComponent<MeshRenderer> ().material = color;
				} else {
					P1_5.GetComponent<MeshRenderer> ().material = defaultColor;
				}
				// 0
				if ((Player1.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player1.transform.localPosition.y <= Need.ball_position_y && (Player1.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player1.transform.localPosition.z <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
					P1_1.transform.GetChild (0).GetComponent<MeshRenderer> ().material = color;
					P1_1.transform.GetChild (1).GetComponent<MeshRenderer> ().material = color;
					P1_1.transform.GetChild (2).GetComponent<MeshRenderer> ().material = color;
				} else {
					P1_1.transform.GetChild (0).GetComponent<MeshRenderer> ().material = defaultColor;
					P1_1.transform.GetChild (1).GetComponent<MeshRenderer> ().material = defaultColor;
					P1_1.transform.GetChild (2).GetComponent<MeshRenderer> ().material = defaultColor;
				...
				if ((Player1.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player1.transform.localPosition.y <= Need.ball_position_y && Player1.transform.localPosition.z >= Need.ball_position_z && (Player1.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
					P1_2.transform.GetChild (0).GetComponent<MeshRenderer> ().material = color;
					P1_2.transform.GetChild (1).GetComponent<MeshRenderer> ().material = color;
					P1_2.transform.GetChild (2).GetComponent<MeshRenderer> ().material = color;
				} else {
					P1_2.transform.GetChild (0).GetComponent<MeshRenderer> ().material = defaultColor;
					P1_2.transform.GetChild (1).GetComponent<MeshRenderer> ().material = defaultColor;
					P1_2.transform.GetChild (2).GetComponent<MeshRenderer> ().material = defaultColor;
				...
				if (Player1.transform.localPosition.y >= Need.ball_position_y && (Player1.transform.localPosition.y - 1.25f) <= Need.ball_position_y && Player1.transform.localPosition.z >= Need.ball_position_z && (Player1.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
					P1_3.transform.GetChild (0).GetComponent<MeshRenderer> ().material = color;
					P1_3.transform.GetChild (1).GetComponent<MeshRenderer> ().material = color;
					P1_3.transform.GetChild (2).GetComponent<MeshRenderer> ().material = color;
				} else {
					P1_3.transform.GetChild (0).GetComponent<MeshRenderer> ().material = defaultColor;
					P1_3.transform.GetChild (1).GetComponent<MeshRenderer> ().material = defaultColor;
					P1_3.transform.GetChild (2).GetComponent<MeshRenderer> ().material = defaultColor;
				...
				if (Player1.transform.localPosition.y >= Need.ball_position_y && (Player1.transform.localPosition.y - 1.25f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player1.transform.localPosition.z <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
					P1_4.transform.GetChild (0).GetComponent<MeshRenderer> ().material = color;
					P1_4.transform.GetChild (1).GetComponent<MeshRenderer> ().material = color;
					P1_4.transform.GetChild (2).GetComponent<MeshRenderer> ().material = color;
				} else {
					P1_4.transform.GetChild (0).GetComponent<MeshRenderer> ().material = defaultColor;
					P1_4.transform.GetChild (1).GetComponent<MeshRenderer> ().material = defaultColor;
					P1_4.transform.GetChild (2).GetComponent<MeshRenderer> ().material = defaultColor;
			...
			//if(!Need.ball_direction_x) {
				...
				if ((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z) {
					P2_5.GetComponent<MeshRenderer> ().material = color;
				} else {
					P2_5.GetComponent<MeshRenderer> ().material = defaultColor;
				}
				// 0
				if ((Player2.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player2.transform.localPosition.y <= Need.ball_position_y && (Player2.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player2.transform.localPosition.z <= Need.ball_position_z && !((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
					P2_1.transform.GetChild (0).GetComponent<MeshRenderer> ().material = color;
					P2_1.transform.GetChild (1).GetComponent<MeshRenderer> ().material = color;
					P2_1.transform.GetChild (2).GetComponent<MeshRenderer> ().material = color;
				} else {
					P2_1.transform.GetChild (0).GetComponent<MeshRenderer> ().material = defaultColor;
					P2_1.transform.GetChild (1).GetComponent<MeshRenderer> ().material = defaultColor;
					P2_1.transform.GetChild (2).GetComponent<MeshRenderer> ().material = defaultColor;
				...
				if ((Player2.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player2.transform.localPosition.y <= Need.ball_position_y && Player2.transform.localPosition.z >= Need.ball_position_z && (Player2.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
					P2_2.transform.GetChild (0).GetComponent<MeshRenderer> ().material = color;
					P2_2.transform.GetChild (1).GetComponent<MeshRenderer> ().material = color;
					P2_2.transform.GetChild (2).GetComponent<MeshRenderer> ().material = color;
				} else {
					P2_2.transform.GetChild (0).GetComponent<MeshRenderer> ().material = defaultColor;
					P2_2.transform.GetChild (1).GetComponent<MeshRenderer> ().material = defaultColor;
					P2_2.transform.GetChild (2).GetComponent<MeshRenderer> ().material = defaultColor;
				...
				if (Player2.transform.localPosition.y >= Need.ball_position_y && (Player2.transform.localPosition.y - 1.25f) <= Need.ball_position_y && Player2.transform.localPosition.z >= Need.ball_position_z && (Player2.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
					P2_3.transform.GetChild (0).GetComponent<MeshRenderer> ().material = color;
					P2_3.transform.GetChild (1).GetComponent<MeshRenderer> ().material = color;
					P2_3.transform.GetChild (2).GetComponent<MeshRenderer> ().material = color;
				} else {
					P2_3.transform.GetChild (0).GetComponent<MeshRenderer> ().material = defaultColor;
					P2_3.transform.GetChild (1).GetComponent<MeshRenderer> ().material = defaultColor;
					P2_3.transform.GetChild (2).GetComponent<MeshRenderer> ().material = defaultColor;
				...
				if (Player2.transform.localPosition.y >= Need.ball_position_y && (Player2.transform.localPosition.y - 1.25f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player2.transform.localPosition.z <= Need.ball_position_z && !((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
					P2_4.transform.GetChild (0).GetComponent<MeshRenderer> ().material = color;
					P2_4.transform.GetChild (1).GetComponent<MeshRenderer> ().material = color;
					P2_4.transform.GetChild (2).GetComponent<MeshRenderer> ().material = color;
				} else {
					P2_4.transform.GetChild (0).GetComponent<MeshRenderer> ().material = defaultColor;
					P2_4.transform.GetChild (1).GetComponent<MeshRenderer> ().material = defaultColor;
					P2_4.transform.GetChild (2).GetComponent<MeshRenderer> ().material = defaultColor;
				...
				if ((Player2.transform.localPosition.y + 1.25f) < Need.ball_position_y && (Player2.transform.localPosition.y - 1.25f) > Need.ball_position_y && (Player2.transform.localPosition.y + 2.222f) > Need.ball_position_y && (Player2.transform.localPosition.y - 2.222f) < Need.ball_position_z) {
					...
					Need.isOnPannel2 = true;
				}

				//May only indicate the active Pannel...
			//}
		}
		if (Need.isOnPannel1 || Need.isOnPannel2) {
			Need.isOnPannel = true;
		}
	}
	private void giveBallnewAngleAfterCollisionWithPanel(Collision col)
	{
		//Debug.Log ("Geschw. alt: " + col.rigidbody.velocity); // hier alles invertieren?
		// hier auch freeze hinzufügen
		// 4 middle
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_1" && (Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z) {
			Debug.Log ("4 p1");
		}
		// 0
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_1" && (Player1.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player1.transform.localPosition.y <= Need.ball_position_y && (Player1.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player1.transform.localPosition.z <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
			Debug.Log ("0 p1"); // z+ y+
			//col.rigidbody.velocity = new Vector3(col.rigidbody.velocity.x - bounceDeviationFactor, col.rigidbody.velocity.y + bounceDeviationFactor, col.rigidbody.velocity.z + bounceDeviationFactor);
			col.rigidbody.AddForce(new Vector3(0, bounceDeviationFactor, bounceDeviationFactor));
		}

		// 1
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_1" && (Player1.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player1.transform.localPosition.y <= Need.ball_position_y && Player1.transform.localPosition.z >= Need.ball_position_z && (Player1.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
			Debug.Log ("1 p1"); // z- y+
			//col.rigidbody.velocity = new Vector3(col.rigidbody.velocity.x - bounceDeviationFactor, col.rigidbody.velocity.y + bounceDeviationFactor, col.rigidbody.velocity.z - bounceDeviationFactor);
			col.rigidbody.AddForce(new Vector3(0, bounceDeviationFactor, -bounceDeviationFactor));
		}
		...
		// 2
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_1" && Player1.transform.localPosition.y >= Need.ball_position_y && (Player1.transform.localPosition.y - 1.25f) <= Need.ball_position_y && Player1.transform.localPosition.z >= Need.ball_position_z && (Player1.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
			Debug.Log ("2 p1"); // y- z-
			//col.rigidbody.velocity = new Vector3(col.rigidbody.velocity.x - bounceDeviationFactor, col.rigidbody.velocity.y - bounceDeviationFactor, col.rigidbody.velocity.z - bounceDeviationFactor);
			col.rigidbody.AddForce(new Vector3(0, -bounceDeviationFactor, -bounceDeviationFactor));
		}
		...
		// 3
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_1" && Player1.transform.localPosition.y >= Need.ball_position_y && (Player1.transform.localPosition.y - 1.25f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player1.transform.localPosition.z <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
			Debug.Log ("3 p1"); // z+ y-
			//col.rigidbody.velocity = new Vector3(col.rigidbody.velocity.x - bounceDeviationFactor, col.rigidbody.velocity.y - bounceDeviationFactor, col.rigidbody.velocity.z + bounceDeviationFactor);
			col.rigidbody.AddForce(new Vector3(0, -bounceDeviationFactor, bounceDeviationFactor));
		}
		...
		// p2
		// 4 middle
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_2" && (Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z) {
			Debug.Log ("p2 4");
		}

		// 0
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_2" &&  (Player2.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player2.transform.localPosition.y <= Need.ball_position_y && (Player2.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player2.transform.localPosition.z <= Need.ball_position_z && !((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
			Debug.Log ("p2 0"); // nur z invertieren im ggs. zu 1?
			//col.rigidbody.velocity = new Vector3(col.rigidbody.velocity.x + bounceDeviationFactor, col.rigidbody.velocity.y + bounceDeviationFactor, col.rigidbody.velocity.z + bounceDeviationFactor);
			col.rigidbody.AddForce(new Vector3(0, bounceDeviationFactor, bounceDeviationFactor));
		}

		// 1
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_2" && (Player2.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player2.transform.localPosition.y <= Need.ball_position_y && Player2.transform.localPosition.z >= Need.ball_position_z && (Player2.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
		//if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_2" && (Player1.transform.localPosition.y + 1.25f) >= Need.ball_position_y && Player1.transform.localPosition.y <= Need.ball_position_y && Player1.transform.localPosition.z >= Need.ball_position_z && (Player1.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
			Debug.Log ("p2 1");
			//col.rigidbody.velocity = new Vector3(col.rigidbody.velocity.x + bounceDeviationFactor, col.rigidbody.velocity.y + bounceDeviationFactor, col.rigidbody.velocity.z - bounceDeviationFactor);
			col.rigidbody.AddForce(new Vector3(0, bounceDeviationFactor, -bounceDeviationFactor));
		}
		...
		// 2
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_2" && Player2.transform.localPosition.y >= Need.ball_position_y && (Player2.transform.localPosition.y - 1.25f) <= Need.ball_position_y && Player2.transform.localPosition.z >= Need.ball_position_z && (Player2.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
		//if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_2" && Player1.transform.localPosition.y >= Need.ball_position_y && (Player1.transform.localPosition.y - 1.25f) <= Need.ball_position_y && Player1.transform.localPosition.z >= Need.ball_position_z && (Player1.transform.localPosition.z - 2.222f) <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
			Debug.Log ("p2 2");
			//col.rigidbody.velocity = new Vector3(col.rigidbody.velocity.x + bounceDeviationFactor, col.rigidbody.velocity.y - bounceDeviationFactor, col.rigidbody.velocity.z - bounceDeviationFactor);
			col.rigidbody.AddForce(new Vector3(0, -bounceDeviationFactor, -bounceDeviationFactor));
		}
		...
		// 3
		if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_2" && Player2.transform.localPosition.y >= Need.ball_position_y && (Player2.transform.localPosition.y - 1.25f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player2.transform.localPosition.z <= Need.ball_position_z && !((Player2.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player2.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player2.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player2.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {			
		//if (col.gameObject.name == "Ball" && this.gameObject.name == "Player_2" && Player1.transform.localPosition.y >= Need.ball_position_y && (Player1.transform.localPosition.y - 1.25f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 2.222f) >= Need.ball_position_z && Player1.transform.localPosition.z <= Need.ball_position_z && !((Player1.transform.localPosition.y + 0.625f) >= Need.ball_position_y && (Player1.transform.localPosition.y - 0.625f) <= Need.ball_position_y && (Player1.transform.localPosition.z + 1.111f) >= Need.ball_position_z && (Player1.transform.localPosition.z - 1.111f) <= Need.ball_position_z)) {
			Debug.Log ("p2 3");
			//col.rigidbody.velocity = new Vector3 (col.rigidbody.velocity.x + bounceDeviationFactor, col.rigidbody.velocity.y - bounceDeviationFactor, col.rigidbody.velocity.z + bounceDeviationFactor);
			col.rigidbody.AddForce(new Vector3(0, -bounceDeviationFactor, +bounceDeviationFactor));
		}
		//Debug.Log ("Geschw. neu: " + col.rigidbody.velocity);		
	}
